...
| `playbook.md` | The seven questions officials ask, reply decision trees, escalation ladder. |

### Data

| File | What it is |
|---|---|
| `facilities.md` | 27 facilities, 18 towns, 179,933 sq ft, 23 owned. The personalization source. |
| `grant_history.md` | Funders 2022 to 2027, $1.75M. What is already committed, and the gap. |
| `targets.csv` | 51 contacts, sorted in send order. Contact and email still `TO VERIFY`. |
| `tracker.csv` | The same 51, banded and assigned to an owner. Fill as you go. |
| `sources.md` | Every source, graded. Every open question. Read before believing anything. |

### Templates, in the order you will use them
...
| `templates/thank_you_email.md` | Within 24 hours of every meeting. |
| `templates/capability_onepager.md` | The leave behind. Handed out on the way out, not the way in. |
| `templates/open_house_invite.md` | Month 2 to 3. The strongest conversion tool available. |
...
- **Sell capacity, not sympathy.** Everyone has a sad story. Almost nobody can run 24 hour
  skilled nursing.
- **Counties outrank towns.** Bergen alone covers 14 of the 18 towns. One conversation there
...
- `2026_Facility_List.xlsx` and `Grant_Updates.xlsx`, both supplied by Antonio 2026-08-31.
  Every Spectrum figure in this folder traces to one of them or to the verified organization
  facts list.
- Outlook account confirmed 2026-08-31: Antonio Salters, asalters@spectrumforliving.org.
- No external web source was reachable. Full record in `sources.md`.
